...
export default function Form(){
    ...
    const [messageMedia, setMessageMedia] =useState ("Preencha as Baixas");
...
function comparacao(){
    if (media < 5) {
        setComparation("Nossa, poucas mortes. Parabéns!")
    } else {
        setComparation("Uau, quantas mortes." + "\n" + "Se continuar assim vai rolar TPK.")
    }
}
...
function validationMedia(){
    if (baixa1 != null && baixa2 != null && baixa3 != null && baixa4 != null){
        ...
        setBaixa4(null)
        comparacao()
        setMessageMedia(" A média de baixas é: ")
